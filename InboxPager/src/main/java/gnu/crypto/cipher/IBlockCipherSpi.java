 ...
 * concrete {@link BaseCipher} sub-classes.</p>
 *
...
interface IBlockCipherSpi extends Cloneable {
   ...
   /**
    * <p>Returns an {@link Iterator} over the supported block sizes.
    * Each element returned by this object is a {@link Integer}.</p>
    *
   ...
   /**
    * <p>Returns an {@link Iterator} over the supported key sizes.
    * Each element returned by this object is a {@link Integer}.</p>
    *
